...
import deleteAccountHandler from './routes/user/delete-account.js';
...
app.post('/api/user/delete-account', adapt(deleteAccountHandler));
app.delete('/api/user/delete-account', adapt(deleteAccountHandler));
