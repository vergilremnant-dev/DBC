  ...
  return `
    <div class="mobile-container p-4 space-y-5 select-none pb-24">
      ...
      <div class="p-4 bg-white border border-stone-200 rounded-2xl space-y-1 shadow-sm">
        ...
        <button onclick="${onNavigateTab ? `onNavigateTab('HelpCenter')` : ''}" class="w-full min-h-[44px] px-3 py-2 flex items-center justify-between hover:bg-stone-50 rounded-xl text-xs font-bold text-stone-800 transition">
